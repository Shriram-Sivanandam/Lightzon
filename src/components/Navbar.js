        ...
        <nav className="navbar">
            <div className="navbar_container">
                ...
                <ul className={click ? 'nav_menu active' : 'nav_menu'}>
                    ...
                    <li className='nav_item'>
                        <a className='nav_links_mobile' href="https://wa.me/918667401982" target="_blank" rel="noreferrer">
                            <div>
                                <btn className='btns' buttonStyle='btn--outline' buttonSize='btn--large'>Contact Us</btn>
                            </div>
                        </a>
                    </li>
                </ul>
                {button && <a className='nav_links_mobile' href="https://wa.me/918667401982" target="_blank" rel="noreferrer">
                            <div>
                                <btn className='btns' buttonStyle='btn--outline' buttonSize='btn--large'>Contact Us</btn>
                            </div>
                        </a>}
